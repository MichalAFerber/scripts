...
Detects:  SxxEyy, S xx E yy, (S5 E6), 2x05 / 2 x 05 / 2 x 5, Season 4, Episode 5
...
RE_X            = re.compile(r"(?<!\d)(\d{1,2})\s*[xX\u00d7]\s*(\d{1,2})(?!\d)")  # 2x05, 2 x 05, 2 x 5
