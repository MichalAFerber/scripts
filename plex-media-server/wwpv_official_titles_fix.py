...
# Adjust this to your series root (the folder that contains "Season 00", "Season 02", etc.)
...
if s00.exists():
    ...
    for idx, (title, pat) in enumerate(zip(s01_titles, s01_matchers), start=1):
        target_name_re = re.compile(rf"S01E{idx:02d}\b", re.I)
